...
from evaluation.statistic import divergence_free, rms_vel_mag, dissipation, taylor_micro_scale, kolmogorov_length_scale, kolmogorov_time_scale, reynolds_num, e_spectrum
...
# @hydra.main(version_base=None, config_path="../outputs/train_ddpm/2024-06-18/15-36-42/.hydra", config_name="config") #hubersum nt6 dim32
@hydra.main(version_base=None, config_path="../outputs/train_ddpm/2024-06-18/15-40-11/.hydra", config_name="config") #hubersum nt6 dim64
